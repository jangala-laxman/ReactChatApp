        ...
        <div className="user-card">          
          ...
          { createuser && (
            <div className="add_dropdown">
              <input type="text" placeholder="add user" value={addvalue} onChange={onAddContact} /><button onClick={addnewUser}><a href="https://reactchatappclientback.onrender.com" target="blank">add</a></button>
